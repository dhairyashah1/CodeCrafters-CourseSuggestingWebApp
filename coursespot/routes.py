...
@app.route("/astronomy")
def astronomy():
    return render_template("astronomy.html",course_dict_5=course_dict[5],x=len(course_dict[5]),astro_img=astro_img)

@app.route("/computerscience")
def compscience():
    return render_template('computerscience.html',course_dict_0=course_dict[0],j=0,x=len(course_dict[0]),comp_img=comp_img)

@app.route("/computerscience2")
def compscience2():
    return render_template('computerscience2.html',course_dict_0=course_dict[0],j=0,x=len(course_dict[0]),comp_img=comp_img)

@app.route("/computerscience3")
def compscience3():
    return render_template('computerscience3.html',course_dict_0=course_dict[0],j=0,x=len(course_dict[0]),comp_img=comp_img)

@app.route("/computerscience4")
def compscience4():
    return render_template('computerscience4.html',course_dict_0=course_dict[0],j=0,x=len(course_dict[0]),comp_img=comp_img)


@app.route("/datascience")
def datascience():
    return render_template("datascience.html",course_dict_1=course_dict[1],x=len(course_dict[1]),data_img=data_img)

@app.route("/economics")
def economics():
    return render_template("economics.html",course_dict_2=course_dict[2],x=len(course_dict[2]),eco_img=eco_img)

@app.route("/maths")
def maths():
    return render_template("math.html",course_dict_3=course_dict[3],x=len(course_dict[3]),math_img=math_img)

@app.route("/physics")
def physics():
    return render_template("physics.html",course_dict_4=course_dict[4],x=len(course_dict[4]),phy_img=phy_img)